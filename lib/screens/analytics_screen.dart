...
class AnalyticsScreen extends StatelessWidget {
    ...
    return Scaffold(
        ...
        body: SafeArea(
          ...
          children: [
            ...
            Text('Historical data and operational insights.',
                style: TextStyle(
                  ...
                  Expanded(
                    child: Row(
                      ...
                      children: [
                        ...
                        _buildBar(0.65, 'Su',
                            colorScheme.primary), // highlight current
                      ],
                    ),
                  )
                ],
            ...
            Row(
              children: [
                Expanded(
                  child: _buildKpiCard(context, 'Avg Temp', '23.1°C',
                      Icons.thermostat, colorScheme.primary,
                      progress: 0.55),
                ),
                const SizedBox(width: 16),
                Expanded(
                  child: _buildKpiCard(context, 'Growth Rate', '+4.2%',
                      Icons.trending_up, colorScheme.primaryContainer,
                      isGood: true, progress: 0.8),
                )
              ],
            ),
            const SizedBox(height: 16),
            Row(
              children: [
                Expanded(
                  child: _buildKpiCard(context, 'Energy Use', '142 kWh',
                      Icons.electrical_services, Colors.orange,
                      progress: 0.7),
                ),
                const SizedBox(width: 16),
                Expanded(
                  child: _buildKpiCard(context, 'Water Saved', '320 L',
                      Icons.water_drop, colorScheme.secondary,
                      progress: 0.4),
                )
              ],
            )
  ...
  Widget _buildKpiCard(BuildContext context, String title, String value,
      ...
      {bool isGood = false, double progress = 0.5}) {
    final colorScheme = Theme.of(context).colorScheme;
    final isDark = colorScheme.brightness == Brightness.dark;
